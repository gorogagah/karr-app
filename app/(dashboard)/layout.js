...
import { ArchiveBoxIcon, BellIcon, BuildingStorefrontIcon, Cog8ToothIcon, CurrencyDollarIcon, EyeIcon, InboxIcon, ReceiptPercentIcon, ShoppingBagIcon, Squares2X2Icon, UserCircleIcon, UserGroupIcon } from '@heroicons/react/24/solid';
            ...
            <nav className="fixed z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 px-3 py-3 lg:px-5 lg:pl-3">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                        <Button className="p-2 text-gray-500 rounded-lg sm:hidden hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
